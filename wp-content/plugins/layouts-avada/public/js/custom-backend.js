var IntegrationAvada = IntegrationAvada || {};


IntegrationAvada.PostEditPageOverrides = function ($) {
	var self = this, themes = IntegrationAvada.templates;
...
(function ($) {
	$(function () {
		IntegrationAvada.PostEditPageOverrides.call({}, $);
	});
}(jQuery));