...
<div class="modman-inline-module-manager">
	...
	<button class="button button-large modman-addnew-module-inline"><?php _e( 'Create a New Module', 'module-manager' ); ?></button>
		...
		<p class="modman_learn_about_modules">
			<a href="https://toolset.com/documentation/user-guides/export-import/using-toolset-module-manager/?utm_source=plugin&utm_medium=gui&utm_campaign=modulmanager" target="_blank"><?php _e( 'Learn about modules', 'module-manager' ); ?></a>
		</p>
	<?php } ?>
</div>
<?php
