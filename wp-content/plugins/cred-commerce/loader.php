        ...
        if (empty(self::$__dependencies__))
        {
            self::$__dependencies__=array (
                ...
                'CLASS'=>array(
	                ...
	                'Notification_Handler' => array(
		                array(
			                'class' => 'CRED_Commerce_Forms_Meta_Handler',
			                'path' => CRED_COMMERCE_CLASSES_PATH.'/CRED_Commerce_Forms_Meta_Handler.php'
		                ),
		                array(
			                'class' => 'CRED_Commerce_User__Notification_Form_HandlerBase',
			                'path' => CRED_COMMERCE_CLASSES_PATH.'/CRED_Commerce_User_Form_Notification_Handler.php'
		                ),
		                array(
			                'class' => 'CRED_Commerce_Post__Notification_Form_HandlerBase',
			                'path' => CRED_COMMERCE_CLASSES_PATH.'/CRED_Commerce_Post_Form_Notification_Handler.php'
		                ),
	                )
                ),
                'PLUGIN'=>array(
