...
Plugin URI: https://toolset.com/course-lesson/charge-users-for-submitting-content/?utm_source=plugin&utm_medium=gui&utm_campaign=formscommerce
...
if ( ! defined( 'CRED_COMMERCE_VERSION' ) ) {
	define( 'CRED_COMMERCE_VERSION', '1.8.4-b1' );
	...
	function toolset_cred_commerce_plugin_plugin_row_meta( $plugin_meta, $plugin_file, $plugin_data, $status ) {
		...
		if ( $plugin_file == $this_plugin ) {
			...
			$plugin_meta[] = sprintf(
				...
				__( 'Toolset Forms Commerce ' . CRED_COMMERCE_VERSION . ' release notes', 'wp-cred-pay' )
			);
		}
...
function cred_commerce_deactivate_notice() {
    ...
    <div class="notice notice-success is-dismissible">
        <p><?php _e( 'Toolset Forms Commerce is now part of Toolset Forms plugin. We deactivated Toolset Forms Commerce for you. You can safely remove it from your site.', 'wp-cred-pay' ); ?></p>
    </div>
	<?php
}
