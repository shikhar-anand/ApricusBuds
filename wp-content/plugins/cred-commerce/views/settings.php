        ...
        <div class="cred-fieldset">
        	...
        	<ul>
				<?php if (defined('CRED_FE_VERSION') && version_compare(CRED_FE_VERSION, '1.2', '<')) : ?>
					<li><i class="fa fa-warning"></i> <?php printf(__('%1$s  is installed, but with incorrect version. You need %1$s %2$s or higher. ','wp-cred-pay'),'<strong>CRED</strong>', '1.2'); ?> <a href="https://toolset.com/home/toolset-components/#cred" target="_blank"><?php _e('Update CRED','wp-cred-pay'); ?></a></li>
				<?php elseif (defined('CRED_FORMS_CUSTOM_POST_NAME')) : ?>
					<li><i class="icon-ok fa fa-check"></i> <?php printf(__('%s plugin is installed and activated.','wp-cred-pay'),'<strong>CRED</strong>'); ?></li>
				<?php else : ?>
					<li><i class="fa fa-warning"></i> <?php printf(__('%s plugin is either not installed or not activated.','wp-cred-pay'),'<strong>CRED</strong>'); ?> <a href="https://toolset.com/home/toolset-components/#cred" target="_blank"><?php _e('Buy CRED','wp-cred-pay'); ?></a></li>
				<?php endif; ?>
