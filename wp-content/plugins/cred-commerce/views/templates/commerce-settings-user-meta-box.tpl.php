...
<div>
    ...
    <div class="cred_commerce_panel">
        <fieldset class="cred-fieldset">
            <p>
                <?php _e('When visitors submit this form, Toolset Forms will ask them to pay by buying a product. If you have not done so already, you need to first create a product in the e-commerce plugin.', 'wp-cred-pay'); ?>
            </p>
            <h4>
            ...
            <p>
                <label>
                    ...
                    <span class="cred-tip-link js-cred-tip-link" data-pointer-content="#single_product_tip">
                        <i class="fa fa-question-circle"></i>
                    </span>
                </label>
                <span>
                    <i title="<?php echo esc_attr(__('Please select a product', 'wp-cred-pay')); ?>" id="commerce_product_required" class="fa fa-warning" style="display:none;">&nbsp;</i>&nbsp;
            ...
            <p>
                <label>
                    ...
                    <span class="cred-tip-link js-cred-tip-link" data-pointer-content="#flexible_product_tip">
                        <i class="fa fa-question-circle"></i>
                    </span>
                </label>
                <span>
                    <i title="<?php echo esc_attr(__('Please select a product field', 'wp-cred-pay')); ?>" id="commerce_product_field_required" class="fa fa-warning" style="display:none;"></i>
                    ...
                    <a href="javascript:;" data-cred-bind="{ event: 'click', action: 'refreshFormFields' }" class='cred-refresh-button fa fa-refresh' title="<?php echo esc_attr(__('Click to refresh (if settings changed)', 'wp-cred-pay')); ?>">&nbsp;</a>
                </span>
            </p>
        </fieldset>
        ...
        <fieldset class="cred-fieldset">
            <h4>
                ...
                <span class="cred-tip-link js-cred-tip-link" data-pointer-content="#checkout_process_tip">
                    <i class="fa fa-question-circle"></i>
                </span>
            </h4>
            <p>
                <label>
                    ...
                    <span class="cred-tip-link js-cred-tip-link" data-pointer-content="#clear_cart_yes_tip">
                        <i class="fa fa-question-circle"></i>
                    </span>
                </label>
            </p>
            <p>
                <label>
                    ...
                    <span class="cred-tip-link js-cred-tip-link" data-pointer-content="#clear_cart_no_tip">
                        <i class="fa fa-question-circle"></i>
                    </span>
                </label>
            </p>
        ...
        <fieldset class="cred-fieldset">
            <h4>
                ...
                <span class="cred-tip-link js-cred-tip-link" data-pointer-content="#post_status_tip">
                    <i class="fa fa-question-circle"></i>
                </span>
            </h4>
            <table>
    ...
    (function ($, cred, undefined) {
        $(function () {
            ...
            function replaceFormSubmitEventOption()
            {
                if ($credCommerceEnable.is(':checked'))
                {
                    $_post.find('.cred-notification-event-fieldset').each(function () {
                        var $this = $(this), trigger = 0,
                                ...
                                payment_complete = $this.find('input[value="payment_complete"]'),
                        ...
                        payment_complete.closest('p').show();
                        if (trigger)
                ...
                } else
                {
                    $_post.find('.cred-notification-event-fieldset').each(function () {
                        ...
                        payment_complete.closest('p').hide();
            ...
            $_post.on('change', 'input[name="_cred_commerce[enable]"]', function (event) {
                replaceFormSubmitEventOption();
                if ($(this).is(':checked'))
                    $credCommercePanel.slideFadeDown('fast');
                else
                    $credCommercePanel.slideFadeUp('fast');
            });
