...
/**
 * Class CRED_Commerce_OnPaymentFailed_Event
 *
 * @since 1.7
 */
class CRED_Commerce_Event_OnPaymentFailed extends CRED_Commerce_Event_Base {
	...
	public function execute() {
		...
		if ( ! empty( $cred_forms_meta ) ) {
			...
			// HOOKS API
			do_action( 'cred_commerce_after_payment_failed', $this->data_order );
		}
	}
}