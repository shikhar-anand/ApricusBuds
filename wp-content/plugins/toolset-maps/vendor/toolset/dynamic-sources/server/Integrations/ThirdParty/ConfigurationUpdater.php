...
class ConfigurationUpdater {
	...
	public function initialize() {
		...
		add_action( 'update_toolset_dynamic_sources_config_index', array( $this, 'update_toolset_dynamic_sources_configuration' ) );
		...
		add_action( 'after_switch_theme', array( $this, 'update_toolset_dynamic_sources_configuration' ) );

		// Hook to update configuration after the new plugin has been activated current theme has changed.
		add_action( 'activated_plugin', array( $this, 'update_toolset_dynamic_sources_configuration' ) );
