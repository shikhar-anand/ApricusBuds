...
class Field extends \WPV_Shortcode_Base {
	...
	/**
	 * @var \OTGS\Toolset\Views\Model\Wordpress\Version
	 */
	private $wp_version;

	public function __construct( \OTGS\Toolset\Views\Model\Wordpress\Version $wp_version = null ) {
		$this->wp_version = ( null === $wp_version )
			? new \OTGS\Toolset\Views\Model\Wordpress\Version()
			: $wp_version;
	}
