...
if (! class_exists('TT_Updater_Theme')) :
    ...
    class TT_Updater_Theme
    {
        ...
        protected static $filterPrefix = 'tbt_theme_request_update_';
         ...
         *
         * Returns either an instance of TT_Update_Theme_Info, or NULL if there is
        ...
        public function requestUpdate($queryArgs = array())
        {
            ...
            if (($code == 200) && ! empty($body)) {
                $themeUpdate = TT_Update_Theme_Info::fromJson($body);
         ...
         * successfully, the first argument passed will be an instance of  TT_Update_Theme_Info. Otherwise,
         * it will be NULL. The second argument will be the corresponding return value of
         * wp_remote_get (see WP docs for details).
         *
         * The callback function should return a new or modified instance of TT_Update_Theme_Info or NULL.
         *
         * @param callable $callback
         *
         * @return void
...
if (! class_exists('TT_Update_Theme_Info')) :
    ...
    class TT_Update_Theme_Info
    {
        ...
        /**
         * Create a new instance of TT_Update_Theme_Info from its JSON-encoded representation.
         *
         * @param string $json Valid JSON string representing a theme information object.
         *
         * @return TT_Update_Theme_Info New instance of TT_Update_Theme_Info, or NULL on error.
         */
        public static function fromJson($json)
        {
            ...
            $valid = isset($apiResponse->version) && ! empty($apiResponse->version) && isset($apiResponse->details_url);
            if (! $valid) {
                return null;
            }
