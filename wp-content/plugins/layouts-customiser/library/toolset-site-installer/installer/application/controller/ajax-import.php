...
class TT_Controller_Ajax_Import extends TT_Controller_Abstract
{
    ...
    private function updateSiteURLs( $old_url ) {
    	...
    	if( $wpdb ) {
			$wpdb->query( "UPDATE wp_posts SET post_content=(REPLACE (post_content, '" . $old_url . "', '" . $new_url . "' ) );" );
			$wpdb->query( "UPDATE wp_options SET option_value=(REPLACE (option_value, '" . $old_url . "', '" . $new_url . "' ) );" );
	    }
    }
}