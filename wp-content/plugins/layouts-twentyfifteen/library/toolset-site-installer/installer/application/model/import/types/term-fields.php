...
class TT_Import_Types_Term_Fields extends TT_Import_Types_Post_Fields
{
    /**
     * Post Type
     * @return string
    ...
    {
        return __('Term Fields', 'toolset-themes');
    }
    ...
    {
	    if( ! $this->propertyExists( array( 'term_fields', 'field' ), $this->import_data )
	        && ! is_array( $this->import_data->term_fields->field ) ) {
		    return false;
	    }

	    $items = array();

        foreach ($this->import_data->term_fields->field as $xml_field) {
