...
class Stortech_pro_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'stortech';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'stortech' ), $i ),
...
// Initialize.
$stortech_footer_widgets = new Stortech_pro_Footer_Widgets();
