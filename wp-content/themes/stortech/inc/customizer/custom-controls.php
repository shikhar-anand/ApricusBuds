 ...
 */
class Stortech_Dropdown_Taxonomies_Control extends WP_Customize_Control {
...
class Stortech_Dropdown_Taxonomy_Control extends WP_Customize_Control {
...
class Stortech_Note_Control extends WP_Customize_Control {
...
class Stortech_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class Stortech_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="stortech-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 */
class Stortech_Custom_Radio_Image_Control extends WP_Customize_Control {
...
class Stortech_Customize_Sortable_Control extends WP_Customize_Control {
  ...
  public function render_content() {
    ...
    <ul class="stortech-sortable-list">
      ...
      ?>
        ...
        <li>
            <input class="stortech-sortable-input sortable-hideme" name="<?php echo esc_attr( $value ); ?> " type="hidden"  value="<?php echo esc_attr( $value ); ?>" />
            <span class ="menu-item-handle sortable-span"> <?php echo esc_attr( $choices[$value] ); ?> </span>
          <i class="dashicons dashicons-menu stortech-drag-handle"></i>
        </li>
        ...
        <li class="sortable-hideme">
          <input class="stortech-sortable-value" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
        </li>
...
class Stortech_Icon_Picker extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <input id="stortech-<?php echo esc_attr( $id ); ?>" placeholder="<?php esc_attr_e( 'Click here to select icon', 'stortech' ); ?>" class="stortech-icon-picker input" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
            </label>
		<?php
	}
}
...
class Stortech_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'column';
...
class Stortech_Customize_Column extends WP_Customize_Control {
	public $type = 'hr';
 ...
 * @since  1.0.0
 */
class Stortech_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
