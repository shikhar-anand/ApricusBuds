...
<form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	<label>
		...
		<input type="search" class="search-field" placeholder="<?php echo esc_attr( get_theme_mod('tafri_travel_change_search_placeholder', __('Search', 'tafri-travel')) ); ?>" value="<?php echo esc_attr(get_search_query()) ?>" name="s">
	</label>
